  ...
  return (
    ...
    <section className="py-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            ...
            <p className="text-lg text-white mt-8 mb-8 bg-white/10 p-6 rounded-tr-[3rem] rounded-bl-[3rem]">
            ...
            <div className="mt-8 mb-8">
              <img 
                ...
                className="h-full w-full max-w-3xl rounded-tr-[3rem] rounded-bl-[3rem]"
              />
            </div>
          </div>
          <button
